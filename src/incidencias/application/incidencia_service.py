...
from src.incidencias.domain.incidencia import Incidencia, generar_incidencia_id
from src.incidencias.domain.repository import IncidenciaRepository
from src.incidencias.domain.value_objects import Resolucion, TipoIncidencia
