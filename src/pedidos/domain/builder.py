...
from src.pedidos.domain.pedido import Pedido, generar_pedido_id
from src.pedidos.domain.value_objects import CanalOrigen, TipoCarga, TipoEntrega
from src.shared.value_objects import ContactInfo, Direccion
